...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Replyon — Gestão de Agendamentos" },
      {
        name: "description",
        content:
          "Replyon: agenda, agendamentos, clientes e gestão para o seu negócio de serviços.",
      },
      { property: "og:title", content: "Replyon — Gestão de Agendamentos" },
      {
        property: "og:description",
        content: "Gerencie sua agenda, clientes e profissionais em um só lugar.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Comfortaa:wght@400;500;700&family=Oswald:wght@400;500;600&family=Poppins:wght@300;400;500;600;700&display=swap",
      },
    ],
  }),
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <Topbar />
        <main className="flex-1 px-4 md:px-7 py-6 pb-10">
          <Outlet />
        </main>
      </div>
    </div>
