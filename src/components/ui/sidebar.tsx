...
>(
  (
    ...
    // Usamos openProp e setOpenProp para controle a partir de fora do componente.
    ...
    // Isso facilita estilizar a sidebar com classes do Tailwind.
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Isso é o que cuida do espaçamento da sidebar no desktop */}
        <div
          className={cn(
